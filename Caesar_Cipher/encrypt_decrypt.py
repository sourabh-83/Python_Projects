...
#TODO-2: Inside the "encrypt()" function, shift each letter of the 'original_text' forwards in the alphabet
        # by the shift amount an dprint the encrypted text.
...
# TODO-A: Create a function called 'decrypt()' that takes 'original_text' and shift_amount as 2 inputs

# TODO-B: Inside the 'decrypt()' function, shift each letter of the 'original_text' towards in the aplabets backwards by the shift_amount and print the decrypted text.
